...
import { updateFirstName, updateLastName, updatePhone, updateEmail, updateGender, updatePassword } from "../../Redux/registrationslice";
    ...
    return (
        ...
        >
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <Typography variant="h6" gutterBottom align="center"> Registration </Typography>
                </Grid>
                <Grid item xs={6}>
